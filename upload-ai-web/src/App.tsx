   ...
   <div className='min-h-screen flex flex-col'>
    ...
    <main className="flex p-6 gap-6 flex-1">
      <div className="flex flex-col flex-1 gap-4">
        ...
        <p className='text-sm text-muted-foreground'>Lembre-se: você pode utilizar a variável <code className='text-violet-400'>{'{transcription}'}</code> no seu prompt pra adicionar o conteúdo da transcrição do vídeo selecionado.</p>
      </div>
